...
const AssetTransfer = ({ signer }) => {
    ...
    const handleAssetTransfer = async () => {
        try {
            ...
            setInteractionHash('');
            if (receiver.trim() == '' || assetID.trim() == '' || amount <= 0) {
            ...
            let payload = {
                type: 1,
                receiver: receiver,
                transfer_values: Object.fromEntries(new Map([
                    [assetID, parseInt(amount)]
                ])),
                fuel_price: 1,
                fuel_limit: 100,
    ...
    return (
        <div>
            <div className='mb-4'>
                <div >
                    <Typography className="font-semibold mb-2 text-xs text-pink-500">Receiver: </Typography>
                    <Input
                        onChange={(e) => {
            ...
            <div className='mb-4'>
                <Button onClick={() => handleAssetTransfer()}
                    type="primary"
                    loading={loader}
                    disabled={loader}
                >
